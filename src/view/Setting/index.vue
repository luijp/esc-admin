...
<template>
  <div v-if="isLoaded" class="settings-container">
    <div class="header">
      <h2>全局设置</h2>
      <el-button plain type="primary" @click="handleSaveGlobalSettings">保存</el-button>
    </div>
    <div class="content">
    ...
    <div class="header">
      <h2>个人设置</h2>
      <div class="btn">
        <el-button plain type="success" @click="handleNewCustomSettings">新增</el-button>
        <el-button plain type="primary" @click="handleSaveCustomSettings">保存</el-button>
      </div>
  ...
  <el-dialog v-model="editCustomSettingsRef.showDialog" title="分类管理" width="500">
    <el-form-item :label-width="80" label="k">
      <el-input v-model="editCustomSettingsRef.customSettings.k"/>
    </el-form-item>

    <el-form-item :label-width="80" label="v">
